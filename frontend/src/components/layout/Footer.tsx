      ...
      <div className="max-w-6xl mx-auto px-6 py-14 grid md:grid-cols-4 gap-8">
        <div className="md:col-span-2">
          <Link href="/" className="flex items-center gap-2 mb-3">
            <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-indigo-400 to-violet-600 grid place-items-center">
              <Wind className="w-4 h-4 text-white" />
            </div>
            <span className="font-bold text-white">Lumivox</span>
          </Link>
          <p className="text-sm text-slate-500 max-w-xs">Modern marketing powered by voice and light.</p>
        </div>
        <div>
